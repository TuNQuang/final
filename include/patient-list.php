...
<?php
	...
	$query = "SELECT * FROM `benhnhan` inner join `lichkham` on benhnhan.bnid = lichkham.bnid inner join services on lichkham.services = services.sid order by lichkham.ngaykham DESC";
